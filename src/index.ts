...
import {SimLoading} from './Main/Helpers/Helpers'
...
console.log("ENSURING DIRECTORY IN SYNC \n @@@@@@@@@@@@@@@@ \n")
...
// code. You can also put them in separate files and import them here.
	...
	// fs.mkdirSync(path.join(dirpath, "db"));
...
ipcMain.handle("delete-db", async (event, arg) => {
  return await DeleteDB(arg);
});

ipcMain.handle("rename-db", async(event, arg) => {
  return await RenameDB(arg);
});